...
import p008j$.lang.Iterable;
import p008j$.util.Collection;
import p008j$.util.Iterator;
import p008j$.util.Map;
import p008j$.util.Set;
import p008j$.util.Spliterator;
...
abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T>, p008j$.util.Iterator {
    ...
    final class MapIterator implements java.util.Iterator<Map.Entry<K, V>>, Map.Entry<K, V>, Map.Entry, p008j$.util.Iterator {
        int mEnd;
    ...
    final class EntrySet implements Set<Map.Entry<K, V>>, p008j$.util.Set {
    ...
    final class KeySet implements java.util.Set<K>, p008j$.util.Set {
        public /* synthetic */ void forEach(Consumer consumer) {
            Iterable.CC.$default$forEach(this, consumer);
        }
